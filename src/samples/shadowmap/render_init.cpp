...
SimpleShadowmapRender::SimpleShadowmapRender(uint32_t a_width, uint32_t a_height, uint32_t a_compGroupAxisSize) : m_width(a_width), m_height(a_height), m_compGroupAxisSize(a_compGroupAxisSize)
{
