...
DeferredRender::DeferredRender(uint32_t a_width, uint32_t a_height) : m_width(a_width), m_height(a_height) {}

void DeferredRender::InitVulkan(const char** a_instanceExtensions, uint32_t a_instanceExtensionsCount, uint32_t)
{
  ...
  etna::initialize(etna::InitParams
    {
      .applicationName = "DeferredShadingSample",
...
void DeferredRender::SetupDeviceExtensions()
{
  m_deviceExtensions.push_back(VK_KHR_SWAPCHAIN_EXTENSION_NAME);
}

void DeferredRender::RecreateSwapChain()
{
